...
export function setcircle_charts(data, today, type, unit) {
    if (type == 1) {
        lineColor = "#1ccda9";
        lineColor1 = "rgba(28,205,169,0.31)";
        lineColor2 = "rgba(28,205,169,0)";
    } else if (type == 2) {
        lineColor = "#FF106E";
        lineColor1 = "rgba(255,16,110,0.3)";
        lineColor2 = "rgba(255,16,110,0)";
    } else if (type == 3) {
        lineColor = "#0893fd";
        lineColor1 = "rgba(8,147,253,0.3)";
        lineColor2 = "rgba(8,147,253,0)";
    } else if (type == 4) {
        lineColor = "#ffae3d";
